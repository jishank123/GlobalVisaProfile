  ...
  const loadServices = useCallback(async () => {
    try {
      ...
      if (response.success) {
        ...
        console.log('✅ Services loaded successfully:', servicesData.length, 'services');
            ...
            {services.length === 0 ? (
              <div className="mt-2 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
                <p className="text-sm text-yellow-800">
                  ...
                  <strong>No services available.</strong> Please contact your administrator to add services before converting leads to projects.
                </p>
              </div>
            ) : (
