...
export const authAPI = {
  login: (email, password, isPasswordSetup = false) => 
    apiClient.post('/auth/login', { email, password, isPasswordSetup }),
...
export const queriesAPI = {
  ...
  addResponse: (id, message, isInternal = false) => 
    apiClient.post(`/queries/${id}/responses`, { message, isInternal }),
};
...
export const appointmentsAPI = {
  ...
  addCommunication: (id, communicationData) => 
    apiClient.post(`/appointments/${id}/communications`, communicationData),
};
