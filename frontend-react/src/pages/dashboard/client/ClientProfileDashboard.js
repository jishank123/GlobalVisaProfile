...
const ClientProfileDashboard = () => {
    ...
    // API configuration
    const API_BASE = process.env.REACT_APP_API_URL || 'https://backend.immigrationprofile.com/api';
    ...
    const loadClientProfile = async () => {
        ...
        try {
            ...
            if (profileResponse.success) {
                ...
                console.log('✅ Client profile loaded:', profileResponse.data);
            } else {
    ...
    const renderActiveSection = () => {
        switch (activeSection) {
            ...
            case 'settings':
                return <ClientProfileSettings clientData={clientData} apiCall={apiCall} onRefresh={loadClientProfile} />;
            default:
                return <ClientOverview clientData={clientData} apiCall={apiCall} onRefresh={loadClientProfile} />;
        }
    };
