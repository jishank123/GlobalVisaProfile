        ...
        switch (activeSection) {
            case 'overview':
                return <ClientOverview clientData={clientData}
                    apiCall={apiCall}/>;
            case 'projects':
                return <ClientProjects clientData={clientData}
                    apiCall={apiCall}/>;
            case 'payments':
                return <ClientPayments clientData={clientData}
                    apiCall={apiCall}/>;
            case 'services':
                return <ClientServices clientData={clientData}
                    apiCall={apiCall}/>;
            case 'appointments':
                return <ClientAppointments clientData={clientData}
                    apiCall={apiCall}/>;
            case 'timeline':
                return <ClientTimeline clientData={clientData}
                    apiCall={apiCall}/>;
            case 'queries':
                return <ClientQueries clientData={clientData}
                    apiCall={apiCall}/>;
            case 'settings':
                return <ClientProfileSettings clientData={clientData}
                    apiCall={apiCall}
